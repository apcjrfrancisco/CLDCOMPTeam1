                            ...
                            <form method="post" action="{{ route('customer.store') }}" id="myForm" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10 form-group">
                                        <input name="customer_name" class="form-control" type="text" placeholder="Name">
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Customer
                                        Barangay</label>
                                    <div class="col-sm-10 form-group">
                                        <input name="customer_barangay" class="form-control" type="text"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10 form-group">
                                        <input name="customer_city" class="form-control" type="text" placeholder="City">
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
