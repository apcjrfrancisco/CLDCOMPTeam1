                            ...
                            <form method="post" action="{{ route('supplier.update') }}" id="myForm">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10 form-group">
                                        <input name="supplier_name" value="{{ $supplier->supplier_name }}" class="form-control" type="text" placeholder="Name">
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Supplier Email
                                        Address</label>
                                    <div class="col-sm-10 form-group">
                                        <input name="supplier_email" value="{{ $supplier->supplier_email }}" class="form-control" type="email"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10 form-group">
                                        <input name="supplier_address" value="{{ $supplier->supplier_address }}" class="form-control" type="text"
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Supplier
                                        Barangay</label>
                                    <div class="col-sm-10 form-group">
                                        <input name="supplier_barangay" value="{{ $supplier->supplier_barangay }}" class="form-control" type="text"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10 form-group">
                                        <input name="supplier_city" value="{{ $supplier->supplier_city }}" class="form-control" type="text" placeholder="City">
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
